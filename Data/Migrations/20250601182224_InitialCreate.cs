    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSkills_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LearningAnalyticsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearningAnalytics", x => x.LearningAnalyticsId);
                    table.ForeignKey(
                        name: "FK_LearningAnalytics_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LearningAnalytics_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_LearningAnalytics_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearningProgress", x => x.LearningProgressId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LessonResourceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "Color", "CreatedAt", "Description", "IconUrl", "IsActive", "Name", "SortOrder" },
                values: new object[,]
                {
                    { 1, "#007bff", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(2438), "Learn various programming languages and frameworks", null, true, "Programming", 1 },
                    { 2, "#28a745", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(2611), "UI/UX Design, Graphic Design, and Creative Skills", null, true, "Design", 2 },
                    { 3, "#ffc107", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(2613), "Business skills, Marketing, and Entrepreneurship", null, true, "Business", 3 },
                    { 4, "#dc3545", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(2614), "Data Analysis, Machine Learning, and Statistics", null, true, "Data Science", 4 },
                    { 5, "#6f42c1", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(2615), "SEO, Social Media, Content Marketing", null, true, "Digital Marketing", 5 }
                });

            migrationBuilder.InsertData(
                table: "Tags",
                columns: new[] { "TagId", "Color", "CreatedAt", "Description", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, "#28a745", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(8795), null, true, "Beginner Friendly" },
                    { 2, "#007bff", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(8957), null, true, "Hands-on" },
                    { 3, "#ffc107", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(8958), null, true, "Certificate" },
                    { 4, "#dc3545", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(8960), null, true, "Popular" },
                    { 5, "#17a2b8", new DateTime(2025, 6, 1, 18, 22, 23, 850, DateTimeKind.Utc).AddTicks(8961), null, true, "New" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningAnalytics_ActionType",
                table: "LearningAnalytics",
                column: "ActionType");

            migrationBuilder.CreateIndex(
                name: "IX_LearningAnalytics_CourseId",
                table: "LearningAnalytics",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_LearningAnalytics_LessonId",
                table: "LearningAnalytics",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_LearningAnalytics_UserId_Timestamp",
                table: "LearningAnalytics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizOptions_QuizQuestionId_OrderIndex",
                table: "QuizOptions",
